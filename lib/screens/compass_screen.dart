              ...
              Column(
                children: [
                  ...
                  GlowCard(
                    ...
                    child: Row(
                      children: [
                        Text(_currentSector().emoji, style: TextStyle(fontSize: 36, color: ChiGlowTheme.richRed)),
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Center(child: Text(entry.value.emoji, style: TextStyle(fontSize: 21, color: ChiGlowTheme.richRed))),
                          ),
